...
class Behaviorism extends StatefulWidget {
  const Behaviorism({Key? key}) : super(key: key);

  @override
  State<Behaviorism> createState() => _BehaviorismState();
}

class _BehaviorismState extends State<Behaviorism> {
